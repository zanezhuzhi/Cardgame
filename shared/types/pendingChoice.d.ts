 ...
 */
export type PendingChoice = SalvageChoice | CardSelectChoice | YokaiTargetChoice | YokaiChoiceOption | SelectCardsMultiChoice | SelectCardPutTopChoice | MeiYaoSelectChoice | AkajitaSelectChoice | WheelMonkDiscardChoice | NaginataSoulDiscardChoice | ZhenMuShouTargetChoice | YouguXiangSelectChoice | YinmoluoSelectChoice | DizangConfirmChoice | DizangSelectShikigamiChoice | DizangReplaceShikigamiChoice | ShikigamiTargetChoice | ShikigamiDiscardChoice | ShikigamiExileChoice | ShikigamiNumberInput | ShikigamiConfirmChoice | ShikigamiOptionChoice | HarassmentResistChoice | BossRaidDefenseChoice | ShangHunNiaoExileChoice;
/**
...
export {};
//# sourceMappingURL=pendingChoice.d.ts.map